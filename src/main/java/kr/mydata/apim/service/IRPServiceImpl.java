...
public class IRPServiceImpl implements IRPService {
     ...
     */
    @Override
    public ResIRP001 listAccount(ReqIRP001 req, String api_id, String own_org_cd, String industry) throws JsonProcessingException {
     ...
     */
    @Override
    public ResIRP002 irpBasic(ReqIRP002 req, String api_id, String own_org_cd, String industry) throws JsonProcessingException {
     ...
     */
    @Override
    public ResIRP003 irpDetail(ReqIRP003 req, String api_id, String own_org_cd, String industry) throws JsonProcessingException {
        String sql = "SELECT res_data FROM tb_test_data WHERE api_id = ? and own_org_cd = ? and org_cd = ? and ast_id = ?";
        String res = jdbcTemplate.queryForObject(sql, String.class, Integer.valueOf(api_id), own_org_cd, req.getOrg_code(), req.getAccount_num());
        // to JSON
        mapper.registerModule(new JavaTimeModule());
     ...
     */
    @Override
    public ResIRP004 irpTransactions(ReqIRP004 req, String api_id, String own_org_cd, String industry) throws JsonProcessingException {
        String sql = "SELECT res_data FROM tb_test_data WHERE api_id = ? and own_org_cd = ? and org_cd = ? and ast_id = ?";
        String res = jdbcTemplate.queryForObject(sql, String.class, Integer.valueOf(api_id), own_org_cd, req.getOrg_code(), req.getAccount_num());
        // to JSON
        mapper.registerModule(new JavaTimeModule());
