package kr.mydata.apim.mapper.common;
...
public class ResCmn001Mapper implements RowMapper<ResCmn001> {
	...
	public ResCmn001 mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		List<ResCmn001Sub> list = mapper.readValue(strApiList,
				mapper.getTypeFactory().constructCollectionType(ArrayList.class, ResCmn001Sub.class));
		e.setApi_list(list);
		return e;
	}
}
