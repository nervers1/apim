...
public class CardController {
    ...
    public ResponseEntity<ResCard001> listCards(@RequestHeader(value = "x-api-id") String api_id,
    ...
    public ResponseEntity<ResCard002> cardBasic(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard003> cardPoint(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard004> cardBills(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard005> cardBills(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard006> cardBills(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard007> cardApprovalDomestic(@RequestHeader(value = "x-api-id") String api_id,
                                                           @RequestHeader(value = "x-own-org-cd") String own_org_cd,
                                                           @NotEmpty(message = "card_id 값이 반드시 필요합니다.") @PathVariable(value = "card_id") String card_id,
    ...
    public ResponseEntity<ResCard008> cardApprovalOverseas(@RequestHeader(value = "x-api-id") String api_id,
                                                           @RequestHeader(value = "x-own-org-cd") String own_org_cd,
                                                           @NotEmpty(message = "card_id 값이 반드시 필요합니다.") @PathVariable(value = "card_id") String card_id,
    ...
    public ResponseEntity<ResCard009> cardLoans(@RequestHeader(value = "x-api-id") String api_id,
                                                @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard010> cardLoanRevolving(@RequestHeader(value = "x-api-id") String api_id,
                                                        @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard011> cardLoansShortTerm(@RequestHeader(value = "x-api-id") String api_id,
                                                         @RequestHeader(value = "x-own-org-cd") String own_org_cd,
    ...
    public ResponseEntity<ResCard012> cardLoansLongTerm(@RequestHeader(value = "x-api-id") String api_id,
                                                        @RequestHeader(value = "x-own-org-cd") String own_org_cd,
